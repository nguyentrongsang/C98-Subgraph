...
export class Unfrozen extends ethereum.Event {
  get params(): Unfrozen__Params {
    return new Unfrozen__Params(this);
  }
}

export class Unfrozen__Params {
  _event: Unfrozen;

  constructor(event: Unfrozen) {
    this._event = event;
  }
...
export class C98 extends ethereum.SmartContract {
  static bind(address: Address): C98 {
    return new C98("C98", address);
  }
